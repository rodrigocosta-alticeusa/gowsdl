...
* In Github, fork `https://github.com/rodrigocosta-alticeusa/gowsdl` to your own account
* Get the package using "go get": `go get github.com/rodrigocosta-alticeusa/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/rodrigocosta-alticeusa/gowsdl/`
